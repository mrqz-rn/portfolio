...
function useCarousel() {
    ...
    if (!context) {
        throw new Error("useCarousel must be used within a <Carousel2 />");
    }
    return context;
}
const Carousel2 = React.forwardRef(({ orientation = "horizontal", opts, setApi, plugins, className, children, ...props }, ref) => {
...
export { Carousel2, CarouselContent, CarouselItem, CarouselPrevious, CarouselNext, };
